...
- [#7951](https://github.com/assistant-ui/assistant-ui/pull/7951) [`955fa94`](https://github.com/assistant-ui/assistant-ui/commit/955fa9449d8f03639c372d1bdfdfffd9ff197b83) - feat(react-langgraph): keep finalized voice transcripts in the thread and send them to the graph with the next run, which writes them to the thread state; `@assistant-ui/react-langchain/converter` gains `getMessageModality`, which reads the `additional_kwargs.modality` a transcript carries ([@okisdev](https://github.com/okisdev))

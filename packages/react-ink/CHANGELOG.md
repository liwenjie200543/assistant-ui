...
- [#7681](https://github.com/assistant-ui/assistant-ui/pull/7681) [`911d22e`](https://github.com/assistant-ui/assistant-ui/commit/911d22e6272039e16766b3ef59982e2075fc24dd) - fix: restart fallback elapsed time when the running message changes ([@Kinfe123](https://github.com/Kinfe123))
...
- [#7519](https://github.com/assistant-ui/assistant-ui/pull/7519) [`3499772`](https://github.com/assistant-ui/assistant-ui/commit/3499772862462ce01822391f17d089e0cbbf3054) - fix: clamp the loading spinner's frame interval so a non-positive `intervalMs` cannot spin the terminal at the runtime's 1ms floor ([@Kinfe123](https://github.com/Kinfe123))

- [#7625](https://github.com/assistant-ui/assistant-ui/pull/7625) [`d2195b0`](https://github.com/assistant-ui/assistant-ui/commit/d2195b02b38dfda3ce394a78ba4b06e5879ff36e) - fix: observe active runs when terminal notifications are enabled mid-run ([@Kinfe123](https://github.com/Kinfe123))
...
- [#7298](https://github.com/assistant-ui/assistant-ui/pull/7298) [`bd7e8fa`](https://github.com/assistant-ui/assistant-ui/commit/bd7e8fa9f79ffea10fab0741026d53cdba4cfa70) - fix: calculate word-level diff highlighting only for visible line pairs and reuse it when a preview expands or shrinks. ([@Kinfe123](https://github.com/Kinfe123))

- [#7332](https://github.com/assistant-ui/assistant-ui/pull/7332) [`bf22c31`](https://github.com/assistant-ui/assistant-ui/commit/bf22c3162d375f4a1a4daf51da36ccdb06d50eb6) - fix: find word movement and deletion boundaries from the caret without scanning the preceding draft ([@Kinfe123](https://github.com/Kinfe123))

- [#7263](https://github.com/assistant-ui/assistant-ui/pull/7263) [`aab5aa9`](https://github.com/assistant-ui/assistant-ui/commit/aab5aa94c88ccba584d14b853ec1658e584888fc) - fix: avoid scanning long prompt prefixes when moving, editing or looking up cursor graphemes ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6983](https://github.com/assistant-ui/assistant-ui/pull/6983) [`bb8249d`](https://github.com/assistant-ui/assistant-ui/commit/bb8249d4f9ef27da17739cb3f4ba2e9d6fc7e020) - fix: forward every part renderer option through `MessagePrimitive.Parts`, so configured generative UI renders ([@ephraimduncan](https://github.com/ephraimduncan))

- [#6992](https://github.com/assistant-ui/assistant-ui/pull/6992) [`90f463e`](https://github.com/assistant-ui/assistant-ui/commit/90f463edf9fe3e0b146a5eda786150f85def26d9) - fix: preserve prototype-named tools in runtime toolkits ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6680](https://github.com/assistant-ui/assistant-ui/pull/6680) [`7ff2ab2`](https://github.com/assistant-ui/assistant-ui/commit/7ff2ab26cf66b725b60c9cf0d39d8235dee96d0c) - fix: use terminal display columns for multiline text input movement ([@rupic-app](https://github.com/apps/rupic-app))
...
- [#6628](https://github.com/assistant-ui/assistant-ui/pull/6628) [`7edd4b1`](https://github.com/assistant-ui/assistant-ui/commit/7edd4b1c0278f088795d7454ad2f92a7010da76a) - fix: keep vertical text input movement on grapheme boundaries ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6642](https://github.com/assistant-ui/assistant-ui/pull/6642) [`c87679b`](https://github.com/assistant-ui/assistant-ui/commit/c87679b10e1e73f1dd46cc2578c86badb2b0582a) - fix: keep CRLF line endings intact during text input editing ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6331](https://github.com/assistant-ui/assistant-ui/pull/6331) [`d7de240`](https://github.com/assistant-ui/assistant-ui/commit/d7de2408671187eb24f7fc410cbafb24977ebf37) - fix: reset fallback elapsed time when each run starts ([@Kinfe123](https://github.com/Kinfe123))

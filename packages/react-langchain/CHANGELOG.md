...
- [#7827](https://github.com/assistant-ui/assistant-ui/pull/7827) [`3f6c335`](https://github.com/assistant-ui/assistant-ui/commit/3f6c3351f426e82f45b6f1c0d8d49f3428982eca) - fix: keep a subagent transcript scoped to its own namespace, so a nested subagent's messages no longer replace its parent's transcript while the nested task runs ([@okisdev](https://github.com/okisdev))
...
- [#7954](https://github.com/assistant-ui/assistant-ui/pull/7954) [`cef68c5`](https://github.com/assistant-ui/assistant-ui/commit/cef68c5d90d05dbfe864b3f54012fd646c3595a7) - feat(react-langchain): keep finalized voice transcripts in the thread and send them to the graph with the next run, which writes them to the thread state; an edit or regenerate after them forks from before them and sends them again ([@okisdev](https://github.com/okisdev))

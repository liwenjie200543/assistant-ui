...
- [#7849](https://github.com/assistant-ui/assistant-ui/pull/7849) [`6e128be`](https://github.com/assistant-ui/assistant-ui/commit/6e128beb521d2db527a01e399fd035edcfdadd31) - fix: expose the current thread to assistive technology on react-native-web ([@rupic-app](https://github.com/apps/rupic-app))

- [#7877](https://github.com/assistant-ui/assistant-ui/pull/7877) [`83f5354`](https://github.com/assistant-ui/assistant-ui/commit/83f53542e7f91d1b93489e534b40151ca34094a8) - fix: honor registered data-part fallbacks on native MessageContent and grouped parts ([@Kinfe123](https://github.com/Kinfe123))
...
- [#7838](https://github.com/assistant-ui/assistant-ui/pull/7838) [`3d01501`](https://github.com/assistant-ui/assistant-ui/commit/3d01501c5642b7b0a4f1094a5a0b93976d02eed7) - fix: every distribution re-exports the same shared surface from `@assistant-ui/core`. `@assistant-ui/react-ink` gains `ReadonlyThreadProvider`, `ToolCallMessagePartStatus`, `groupPartByType`, `GroupByContext`, `VoiceSessionState`, the external store runtime (`useExternalStoreRuntime`, `useExternalMessageConverter`, their adapters and options), the message queue, the tool approval types, the generative UI renderer and the cloud thread list hooks; `@assistant-ui/react-native` gains `VoiceSessionState`, the cloud thread list hooks, the generative UI renderer and the runtime state and adapter types the web package already carried; `@assistant-ui/react` gains `MessageRole`, `RunConfig`, `RuntimeCapabilities`, `RemoteThreadListOptions`, `ThreadsState`, `JoinStrategy`, `TitleGenerationAdapter`, `createSimpleTitleAdapter` and `ChainOfThoughtPartByIndexProvider`. ([@okisdev](https://github.com/okisdev))
...
- [#7780](https://github.com/assistant-ui/assistant-ui/pull/7780) [`2d91835`](https://github.com/assistant-ui/assistant-ui/commit/2d91835c6e073329df878e683c27f350c8a80506) - feat: export ReadonlyThreadProvider and ToolCallMessagePartStatus ([@okisdev](https://github.com/okisdev))

- [#7725](https://github.com/assistant-ui/assistant-ui/pull/7725) [`258ad13`](https://github.com/assistant-ui/assistant-ui/commit/258ad136d849f67c06207cd8cfd944364c1e59cf) - fix: expose feedback submission state to assistive technology ([@rupic-app](https://github.com/apps/rupic-app))

- [#7979](https://github.com/assistant-ui/assistant-ui/pull/7979) [`35a58a0`](https://github.com/assistant-ui/assistant-ui/commit/35a58a0916f63e2f9bd8d519e20d4fa480bc3086) - fix: type the `ThreadPrimitive.Messages` children `message` as the `MessageState` the package exports, which is the store state the primitive passes at runtime ([@okisdev](https://github.com/okisdev))
...
- [#7538](https://github.com/assistant-ui/assistant-ui/pull/7538) [`22c9fc6`](https://github.com/assistant-ui/assistant-ui/commit/22c9fc6a34c5ce1e357f5003d6d08d98f165aa65) - feat: action bar and branch picker children receive disabled, and ActionBarPrimitive.Speak and StopSpeaking arrive on react native. ([@okisdev](https://github.com/okisdev))

- [#7538](https://github.com/assistant-ui/assistant-ui/pull/7538) [`22c9fc6`](https://github.com/assistant-ui/assistant-ui/commit/22c9fc6a34c5ce1e357f5003d6d08d98f165aa65) - feat: export MessagePartPrimitive (Text, Image, InProgress, Messages) from the react native distribution. ([@okisdev](https://github.com/okisdev))

- [#7538](https://github.com/assistant-ui/assistant-ui/pull/7538) [`22c9fc6`](https://github.com/assistant-ui/assistant-ui/commit/22c9fc6a34c5ce1e357f5003d6d08d98f165aa65) - feat: ThreadPrimitive.MessagesFlatList takes a history prop that wires loading older messages at the top. ([@okisdev](https://github.com/okisdev))
...
- [#7248](https://github.com/assistant-ui/assistant-ui/pull/7248) [`2a550be`](https://github.com/assistant-ui/assistant-ui/commit/2a550becf98d36a400cc1886bd57dfbe08e07279) - fix: scroll existing threads to their measured bottom offset ([@Kinfe123](https://github.com/Kinfe123))

- [#7347](https://github.com/assistant-ui/assistant-ui/pull/7347) [`39f6783`](https://github.com/assistant-ui/assistant-ui/commit/39f6783c3636159bb577cd6ff4578719f0c0eeb3) - feat: let `ComposerPrimitive.AddAttachment` take an `onPress` handler, so the platform picker runs behind the composer's disabled state instead of on a separate button ([@okisdev](https://github.com/okisdev))

- [#7353](https://github.com/assistant-ui/assistant-ui/pull/7353) [`117fc00`](https://github.com/assistant-ui/assistant-ui/commit/117fc000074480ab63680bb5a9a572c9f1c9a56e) - feat: `ThreadPrimitive.MessagesFlatList` keeps the visible message anchored while older messages load above it (`maintainVisibleContentPosition` defaults to the first visible item and stays overridable) ([@okisdev](https://github.com/okisdev))

- [#7311](https://github.com/assistant-ui/assistant-ui/pull/7311) [`8d39b45`](https://github.com/assistant-ui/assistant-ui/commit/8d39b458ec62b7e3cc4adb399fb960c71505cb32) - feat: export the external store family (useExternalStoreRuntime, the converters, the shared options, the message queue and their types) from @assistant-ui/react-native so React Native apps never import them from the web package ([@okisdev](https://github.com/okisdev))

- [#7402](https://github.com/assistant-ui/assistant-ui/pull/7402) [`668a4e5`](https://github.com/assistant-ui/assistant-ui/commit/668a4e5802d9a5e8eb43b5fcd212319b5842516a) - fix: depend on `assistant-cloud` like `@assistant-ui/react` does, so an app whose runtime is not the AI SDK one can bundle; `@assistant-ui/core` imports it from its react entry and optional peers are not installed ([@okisdev](https://github.com/okisdev))
...
- [#6983](https://github.com/assistant-ui/assistant-ui/pull/6983) [`bb8249d`](https://github.com/assistant-ui/assistant-ui/commit/bb8249d4f9ef27da17739cb3f4ba2e9d6fc7e020) - fix: forward every part renderer option through `MessagePrimitive.Parts`, so configured generative UI renders and data renderers survive `ChainOfThought` ([@ephraimduncan](https://github.com/ephraimduncan))

- [#6986](https://github.com/assistant-ui/assistant-ui/pull/6986) [`afeb71e`](https://github.com/assistant-ui/assistant-ui/commit/afeb71e6e9312950b61a108514405d06a1956fd3) - fix: supply derived status to registered tool and data renderers ([@ephraimduncan](https://github.com/ephraimduncan))
...
- [#6723](https://github.com/assistant-ui/assistant-ui/pull/6723) [`8cc962e`](https://github.com/assistant-ui/assistant-ui/commit/8cc962e4bb33a5d144535373deb8792edd7f6921) - feat: re-export the approval display type and its helper ([@okisdev](https://github.com/okisdev))
...
- [#6240](https://github.com/assistant-ui/assistant-ui/pull/6240) [`2c74460`](https://github.com/assistant-ui/assistant-ui/commit/2c7446086256393b952b65b68fe99a5178e3ab32) - fix: guard Enter-to-send behind running state and canSend ([@Kinfe123](https://github.com/Kinfe123))
...
- [#6132](https://github.com/assistant-ui/assistant-ui/pull/6132) [`16bbf6f`](https://github.com/assistant-ui/assistant-ui/commit/16bbf6fdfdcd6817d63e882db15f634f880377ac) - fix: expose the active state of thread-list items on react-native and react-ink ([@rupic-app](https://github.com/apps/rupic-app))

- [#6120](https://github.com/assistant-ui/assistant-ui/pull/6120) [`c4446c2`](https://github.com/assistant-ui/assistant-ui/commit/c4446c2ebe12cda29b57e60a738f7eff8c18f76f) - fix: expose the active state of ThreadListNew on react-native and react-ink ([@samdickson22](https://github.com/samdickson22))
